...
public class BarrelLockButton extends Button {
    private final ResourceLocation LOCK_TEXTURE = new ResourceLocation(ModReference.MODID, "textures/gui/lock.png");

    public BarrelLockButton(int p_93721_, int p_93722_, int p_93723_, int p_93724_, Component p_93725_, OnPress p_93726_) {
    ...
    public void renderButton(@NotNull PoseStack poseStack, int p_93747_, int p_93748_, float p_93749_) {
        ...
        if (this.isHoveredOrFocused())
            this.blit(poseStack, this.x, this.y, 0, 86, 22, 20);
        else
            this.blit(poseStack, this.x, this.y, 0, 66, 22, 19);
